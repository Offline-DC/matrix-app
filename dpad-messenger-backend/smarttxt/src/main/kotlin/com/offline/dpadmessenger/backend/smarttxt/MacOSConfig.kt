 ...
 *
 * Per SMARTTXT_NATIVE_BACKEND_PLAN.md §2.1, rustpush's auth all hangs off one
 ...
 * that mechanism rather than invent one. [SmartTxtAccountStore] holds this blob
 ...
 * lives behind [com.offline.dpadmessenger.backend.smarttxt.absinthe.AbsintheStub]
