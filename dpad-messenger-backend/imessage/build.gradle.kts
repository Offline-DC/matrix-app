...
android {
    namespace = "com.offline.dpadmessenger.backend.imessage"
    compileSdk = 36
    ...
    // armeabi-v7a}/libimessage_ffi.so. The directory is created and `.gitkept`
...
dependencies {
    ...
    // that IMessageBackendFactory implements (same as :gmessages / :signal).
    api(project(":core"))
    ...
    // WorkManager drives IMessageRenewalWorker (periodic re-registration).
