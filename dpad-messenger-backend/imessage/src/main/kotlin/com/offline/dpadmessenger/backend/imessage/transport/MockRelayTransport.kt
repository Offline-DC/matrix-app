...
/**
 * In-process iMessage relay SIMULATOR implementing the exact [IMessageTransport]
 ...
 *
 * Swap this for [RelayWebSocketTransport] by setting `IMessageConfig
 * .relayBaseUrl`; nothing above the transport changes.
 */
class MockRelayTransport : IMessageTransport {
