package com.offline.dpadmessenger.backend.imessage.absinthe
 ...
 *
 * Per IMESSAGE_NATIVE_BACKEND_PLAN.md §2.5, the `open-absinthe` submodule that
...
class AbsintheUnavailableException(operation: String) : UnsupportedOperationException(
    "open-absinthe nac is closed source and not built into this APK " +
        ...
        "ValidationDataRelay — see IMESSAGE_NATIVE_BACKEND_PLAN.md §2.5/§2.6.",
)
