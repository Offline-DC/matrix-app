...
import com.offline.dpadmessenger.backend.imessage.transport.SendAck
...
/**
 * The live iMessage session — the orchestration layer between the
 * [IMessageMessageRepository] and an [IMessageTransport]. Analog of
...
class IMessageSession(
    private val transport: IMessageTransport,
) {
