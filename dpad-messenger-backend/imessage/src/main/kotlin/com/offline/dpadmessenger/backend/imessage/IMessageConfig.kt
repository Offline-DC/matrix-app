...
/**
 * Host-app configuration for the iMessage backend. Mirror of
 ...
 * incoming-message notification ([IMessageNotifier]) knows what to open when
 * tapped.
 *
...
object IMessageConfig {
    ...
    /**
     * Which transport the session uses (IMESSAGE_NATIVE_BACKEND_PLAN.md §2.6).
     */
    ...
    /**
     * Base URL of the iMessage relay server (e.g. "https://relay.example.com").
     * The relay speaks the [com.offline.dpadmessenger.backend.imessage.transport
     ...
     */
    const val EXTRA_ROOM_ID = "imessage_room_id"
}
