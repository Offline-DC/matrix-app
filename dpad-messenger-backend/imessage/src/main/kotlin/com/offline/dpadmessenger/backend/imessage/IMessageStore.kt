...
/**
 * On-disk cache of conversation state so iMessages persist across app restarts
 ...
 * serializers.
 */
internal class IMessageStore(context: Context) {

    private val ctx = context.applicationContext
    private val file = File(ctx.filesDir, "imessage_cache.enc")
