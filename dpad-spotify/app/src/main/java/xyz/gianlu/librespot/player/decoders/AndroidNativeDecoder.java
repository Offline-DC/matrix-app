...
/**
 * MediaCodec-backed Vorbis/MP3 decoder. Vendored from
 * devgianlu/librespot-android (librespot-android-decoder module, Apache-2.0).
 * Lives in the same package as librespot's abstract {@code Decoder} (from
 * librespot-decoder-api) on purpose — it references package-visible types.
 */
