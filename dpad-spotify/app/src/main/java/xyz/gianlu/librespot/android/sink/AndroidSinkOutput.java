...
/**
 * AudioTrack-backed librespot sink. Vendored from devgianlu/librespot-android
 * (librespot-android-sink module, Apache-2.0).
 * <p>
 * IMPORTANT: this class is instantiated REFLECTIVELY by librespot's AudioSink
 * via {@code PlayerConfiguration.outputClass} — keep the FQCN stable and keep
 * it out of any minification.
 *
 * @author devgianlu
 */
